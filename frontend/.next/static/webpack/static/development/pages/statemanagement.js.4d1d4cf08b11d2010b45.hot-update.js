...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ContentStateManagement, [{
    ...
    value: function componentWillUpdate(prevProps, prevState, snapshot) {
      if (prevProps.foo != this.props.foo) {
        this.setState({
          foo: _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.props.foo)
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.props.foo).length < 20 ? null : _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()(this.props.foo["foo"].forEach(function (item) {
        return item;
      }))));
    }
  }]);
...
//# sourceMappingURL=statemanagement.js.4d1d4cf08b11d2010b45.hot-update.js.map