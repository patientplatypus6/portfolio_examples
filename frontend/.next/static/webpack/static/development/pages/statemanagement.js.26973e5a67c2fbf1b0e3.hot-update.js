...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ContentStateManagement, [{
    ...
    value: function componentWillUpdate(prevProps, prevState, snapshot) {
      console.log('value of prevProps: ', prevProps);
      console.log('value of this.props; ', this.props);

      if (prevProps.foo != this.props.foo && this.props.foo.length > 20) {
        this.setState({
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, this.state.foo.length < 20 ? null : this.state.foo));
    }
  }]);
...
//# sourceMappingURL=statemanagement.js.26973e5a67c2fbf1b0e3.hot-update.js.map