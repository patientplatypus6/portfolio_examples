...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(ContentStateManagement, [{
    ...
    value: function componentWillUpdate(prevProps, prevState, snapshot) {
      if (prevProps.foo != this.props.foo && this.props.foo.length > 30) {
        this.setState({
    ...
    value: function render() {
      ...
      return __jsx("div", {
        ...
        __self: this
      }, this.state.foo == "" ? null : this.state.foo));
    }
  }]);
...
//# sourceMappingURL=statemanagement.js.acea51e91cec3f763928.hot-update.js.map